...
def add_maskformer2_config(cfg):
    ...
    # Color augmentation
    cfg.INPUT.COLOR_AUG_SSD = True #False
    ...
    cfg.MODEL.MASK_FORMER.TRAIN_NUM_POINTS = 500*500 #650 * 650 #136*136 #112 * 112
    # Oversampling parameter for PointRend point sampling during training. Parameter `k` in the
    # original paper.
    cfg.MODEL.MASK_FORMER.OVERSAMPLE_RATIO = 4.0  #2.0 #3.0 #1.0 #3.0
    # Importance sampling parameter for PointRend point sampling during training. Parametr `beta` in
    # the original paper.
    cfg.MODEL.MASK_FORMER.IMPORTANCE_SAMPLE_RATIO = 0.25 #0.75 #0.85  # 0.75
